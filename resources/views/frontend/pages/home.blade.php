...
@section('content')
    <x-splade-data default="{ success: true, show_terms: false}">
        <x-splade-flash>
        ...
        <div
            ...
            <x-splade-form method="POST" action="{{ route('registrationForm.store') }}"
                           default="{agreement: false, citizenship: 'საქართველო', registered_to_participate_in_elections: 1, registration_help: 0, want_consultation: 0, later_registration: 0, transportation_help: 1}">
