<?php \ProtoneMedia\Splade\Facades\SEO::title('Create Admin'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-title','data' => ['heading' => 'Create admin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Create admin']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('administrators.store')).'']); ?>
...
<?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('grant super admin')): ?>
                <div class="mt-4 mb-2">
...
<?php $component = ProtoneMedia\Splade\Components\Form\Checkbox::resolve(['name' => 'super_admin','value' => '1','label' => 'Super Admin'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Select::resolve(['label' => 'Roles','placeholder' => 'Select roles','relation' => true,'name' => 'roles','multiple' => true,'options' => $roles,'choices' => true,'optionLabel' => 'name','optionValue' => 'id'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/abashenici/resources/views/backend/pages/admin/create.blade.php ENDPATH**/ ?>