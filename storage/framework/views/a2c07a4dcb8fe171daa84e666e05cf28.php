...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('settings.update', $setting)).'','method' => 'PUT']); ?>
...
<?php endif; ?>
            ...
            <div class="mt-6 grid gap-6 mb-6 md:grid-cols-2" v-if="form.type === 'blacklisted_words'">
                <repeater-component v-model="form.blacklisted_words" :initial-words="<?php echo e($setting->value); ?>" :errors="errors"/>
            </div>
            <div class="mt-2 mb-2">
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yoshito/Projects/abashenici/resources/views/backend/pages/setting/edit.blade.php ENDPATH**/ ?>