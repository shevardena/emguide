...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['child','animation','afterLeave','animate']));
...
foreach (array_filter((['child','animation','afterLeave','animate']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = ProtoneMedia\Splade\Components\Transition::resolve(['child' => $child,'animation' => $animation,'afterLeave' => $afterLeave,'animate' => $animate] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/yoshito/Projects/abashenici/storage/framework/views/a9da4cc59a8e7ffbf383bfe827eb5943.blade.php ENDPATH**/ ?>